...
EVENT_NAMES = ['Koncert samospevov Josipa Ipavca', 'Odprta kuhna', 'Kulinarični festival Sočna vilica', 'Kranj Foto Fest', 'Razstava: Aleksandra S. Kelc: Anima in TULIPAN', 'HOMMAGE À TONE DEMŠAR: Petindvajset let kasneje', 'Festival pohodništva Dolina Soče', 'Brezplačni ogledi mesta ob evropskem tednu mobilnosti 2022', '24. Svetovno prvenstvo v letenju s toplozračnimi baloni 2022', 'Voden ogled Bleda', 'Blues˛&amp; Beer', 'Kulturno-gastronomski abonma Polna žlica kulture', 'Dobrodelni malteški tek', 'Pivo &amp; Burger Fest v Novem mestu', 'Gala Magic Show', '10. Konjiški maraton', 'Festival Stare trte', '5. Nočni Tek Portorož – finale serije', 'Pomol okusov IV', 'Jestival', 'Svečana trgatev Stare trte', 'Vikend oddih s Krivopeto', 'Odprta kuhna Nova Gorica', 'Frikafest', 'Ecomaratona Collio - Brda', 'Odprta kuhna Ptuj', 'Kras Gravel', 'Teden restavracij / Jesen 2022', 'Odprta kuhna Vipava', 'Sedem si rož; Jubilejnih 70 let Slovenskega okteta in Festivala Ljubljana', 'Volkswagen Ljubljanski maraton', '25. Festival slovenskega filma Portorož', 'WTT Contender Novo Gorica 2022 Presented by I Feel Slovenia', 'Evropsko prvenstvo v rokometu za ženske', 'Pomol okusov V', 'Martinovo v Šmartnem', 'GO4Trail - Tek 3 vrhov', 'Narodnozabavna hit parada 2022', 'Martinov pohod', 'S posvetilom Slovenskemu oktetu; Jubilejnih 70 let Slovenskega okteta in Festivala Ljubljana', 'Čarobni Maribor', 'Božično-novoletni sejem', 'Zimska pravljica 2022/23', 'Miklavževanje', 'Festival penin 2022', '2023 IBU svetovni pokal v biatlonu - Pokljuka', 'Mednarodni festival Čili in čokolada', 'Gregorjevo - Vuč u vodo', '58. Festival Borštnikovo srečanje', '2023 Evropsko prvenstvo v veslanju', 'Festival Lent 2023', 'Postavljanje klopotca pred Hišo Stare trte', 'Šuštarska nedelja', '2023 IBU mladinski pokal v biatlonu']