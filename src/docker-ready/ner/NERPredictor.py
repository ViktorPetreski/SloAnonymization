...
from vp_ta_constants import TAG_SCHEME_COMBINED

class NERPredictor:
    def __init__(self, tokenizer_path_name, model_path_name) -> None:
    ...
    def init_model(self):
        ...
        return CamembertForTokenClassification.from_pretrained(self.model_path, use_auth_token="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")
